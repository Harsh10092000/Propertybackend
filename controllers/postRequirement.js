...
export const postRequirement = (req, res) => {
  ...
  db.query(q, [values], (err, data) => {
    ...
    let info = {
      ...
      subject: `Query ID - ${1000+parseInt(id)} Property Requirement from ${req.body.data_name}`, // Subject line
                             ...
                             <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 30px 0px 0px 0px;">
                                ...
                                <tr>
                                   <td height="10px" style="font-size: 16px;line-height: 24px;letter-spacing:.3px;">
                                      ...
                                      <p style="margin-bottom: 10px; font-size: 16px;">${req.body.data_email} submitted new property requirement. </b></p>
                                      <p style="margin-bottom: 10px; font-size: 16px;">You can Contact him/her on ${req.body.data_phone}</p>
                                      <p style="margin-bottom: 10px; font-size: 16px;">Property Requirement Details : </p>
                                      <p style=" font-size: 16px;">Property Type - ${req.body.data_pro_type}</p>
                                      <p style=" font-size: 16px;">Location - ${req.body.data_in_city}</p>
                                      <p style=" font-size: 16px;">Plot Size - ${req.body.data_pro_size + " " + req.body.data_pro_size_unit}</p>
                                      <p style="margin-bottom: 10px; font-size: 16px;">Client Budget - ${req.body.data_price_quo}</p>
                                   </td>
                                </tr>
                                <tr>
                         ...
                         <tr>
                            <td>
                               <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 30px 0px 0px 0px;">
                                  ...
                                  <tr>
                                     <td height="10px" style="font-size: 16px;line-height: 24px;letter-spacing:.3px;">
                                        <p style="color:#404040; margin-bottom: 10px;"> Dear ${req.body.data_name},</b>
                                        
                                        <p style="margin-bottom: 10px; font-size: 16px;">Thank you for posting your requirement. Your Query Id is ${1000+parseInt(id)}  We will be in touch with you soon.</p>
