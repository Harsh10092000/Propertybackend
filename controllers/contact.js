                          ...
                          <td>
                             <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 30px 0px 0px 0px;">
                                ...
                                <tr>
                                   <td height="10px" style="font-size: 16px;line-height: 24px;letter-spacing:.3px;">
                                      <p style="color:#404040; margin-bottom: 10px;"> Dear Admin,</b>
                                       <p style="margin-bottom: 10px; font-size: 16px;">${req.body.name} is contacting us.</b></p>
                                       <p style="margin-bottom: 10px; font-size: 16px;">Email : ${req.body.email}</p>
                                       <p style="margin-bottom: 10px; font-size: 16px;">Phone Number : ${req.body.phone}</p>
                                       <p style="margin-bottom: 10px; font-size: 16px;">User Message : ${req.body.message}</p>
                                   </td>
                                </tr>
                                <tr>
                                   <td height="10px" style="font-size: 15px;line-height: 24px;letter-spacing:.3px;">
